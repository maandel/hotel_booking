...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
            ...
            for model_name, model_class in data["models"]:
                ...
                for perm_type, perm_display in Permission.PERMISSION_TYPES:
                    ...
                    if not Permission.objects.filter(codename=codename).exists():
                        ...
                        self.stdout.write(
                            f"  - Already exists: Can {perm_display.lower()} {model_name}"
                        )
        ...
        self.stdout.write("\n🚀 NEXT STEPS:")
        self.stdout.write(
            "  1. Create roles: python manage.py createsuperuser (for admin access)"
        )
        ...
        self.stdout.write(
            "  5. Test access: python manage.py test_user_access <username>"
        )
