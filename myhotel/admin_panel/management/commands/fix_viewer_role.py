...
from hotel.models import Permission, Role
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            self.stdout.write(
                f"Found Viewer role with {viewer_role.permissions.count()} permissions"
            )
            ...
            self.stdout.write(
                f"Updated Viewer role. Now has {viewer_role.permissions.count()} permissions:"
            )
