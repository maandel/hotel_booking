...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "codename", type=str, help="Permission codename (e.g., manage_reports)"
        )
        parser.add_argument(
            "name", type=str, help='Permission name (e.g., "Can manage reports")'
        )
    ...
    def handle(self, *args, **options):
        ...
        generic_ct, created = ContentType.objects.get_or_create(
            app_label="admin_panel", model="custom"
        )
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f"❌ Error creating permission: {e!s}"))
