    ...
    def handle(self, *args, **options):
        ...
        user_permissions = [
            ...
            (
                "edit_user",
                "Can edit users",
                "Permission to edit existing user accounts",
                "user_edit",
            ),
            (
                "delete_user",
            ...
            (
                ...
                "Permission to assign and manage user roles",
                "user_roles",
            ),
            (
                "manage_user_status",
        ...
        if not Permission.objects.filter(codename="access_user_manager").exists():
            user_manager_ct, _ = ContentType.objects.get_or_create(
                app_label="admin_panel", model="user_manager_access"
            )
            ...
            self.stdout.write("  - Already exists: Can access user manager section")
