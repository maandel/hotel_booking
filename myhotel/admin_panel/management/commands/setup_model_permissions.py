...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        model_categories = {
            ...
            "guest": {"models": [("guest", Guest)], "description": "Guest Management"},
            "room_setup": {
                "models": [
                    ("room", Room),
                    ("roomtype", RoomType),
            ...
            "hotel_setup": {
                "models": [("hotel", Hotel), ("hotelamenity", HotelAmenity)],
        ...
        for _category, data in model_categories.items():
        ...
        category_permissions = [
            ...
            (
                "access_room_setup",
                "Can access room setup section",
                "Access to room setup and management",
            ),
            (
                "access_hotel_setup",
                "Can access hotel setup section",
                "Access to hotel setup and management",
            ),
            (
                "access_room_amenities",
                "Can access room amenities section",
                "Access to room amenities management",
            ),
            (
                "access_hotel_amenities",
                "Can access hotel amenities section",
                "Access to hotel amenities management",
            ),
            (
                "access_contact",
                "Can access contact section",
                "Access to contact form management",
            ),
            (
                "access_account",
                "Can access account section",
                "Access to account and permission management",
            ),
        ]

        # Create a generic content type for category permissions
        generic_ct, _ = ContentType.objects.get_or_create(
            app_label="admin_panel", model="category"
        )
        ...
        custom_permissions = [
            ...
            (
                "restore_system",
                "Can restore system",
                "Permission to restore system from backups",
            ),
        ]
        ...
        self.stdout.write(
            "  • python manage.py create_custom_permission <codename> <name> <description>"
        )
        self.stdout.write("  • python manage.py test_user_access <username>")
        self.stdout.write(
            "  • python manage.py list_permissions [--category=<category>]"
        )
