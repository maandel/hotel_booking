...
from .views.guest_views import (
    AdminGuestCreateView,
    AdminGuestDeleteView,
    AdminGuestEditView,
    AdminGuestListView,
)
from .views.hotel_amenity_views import (
    AdminHotelAmenityCreateView,
    AdminHotelAmenityDeleteView,
    AdminHotelAmenityEditView,
    AdminHotelAmenityListView,
)
...
from .views.room_amenity_views import (
    AdminRoomAmenityCreateView,
    AdminRoomAmenityDeleteView,
    AdminRoomAmenityEditView,
    AdminRoomAmenityListView,
)
from .views.room_type_views import (
    AdminRoomTypeCreateView,
    AdminRoomTypeDeleteView,
    AdminRoomTypeEditView,
    AdminRoomTypeListView,
)
...
urlpatterns = [
    ...
    path(
        "bookings/<int:booking_id>/edit/", admin_booking_edit, name="admin_booking_edit"
    ),
    path(
    ...
    path(
        ...
        api_check_room_availability,
        name="api_check_room_availability",
    ),
    # Hotel Management
    ...
    path(
        "guests/<int:pk>/edit/", AdminGuestEditView.as_view(), name="admin_edit_guest"
    ),
    path(
        "guests/<int:pk>/delete/",
        AdminGuestDeleteView.as_view(),
        name="admin_delete_guest",
    ),
    # Room Amenities
    path(
        "room-amenities/",
        AdminRoomAmenityListView.as_view(),
        name="admin_room_amenities",
    ),
    path(
        "room-amenities/add/",
        AdminRoomAmenityCreateView.as_view(),
        name="admin_add_room_amenity",
    ),
    path(
        "room-amenities/<int:pk>/edit/",
        AdminRoomAmenityEditView.as_view(),
        name="admin_edit_room_amenity",
    ),
    path(
        "room-amenities/<int:pk>/delete/",
        AdminRoomAmenityDeleteView.as_view(),
        name="admin_delete_room_amenity",
    ),
    # Hotel Amenities
    path(
        "hotel-amenities/",
        AdminHotelAmenityListView.as_view(),
        name="admin_hotel_amenities",
    ),
    path(
        "hotel-amenities/add/",
        AdminHotelAmenityCreateView.as_view(),
        name="admin_add_hotel_amenity",
    ),
    path(
        "hotel-amenities/<int:pk>/edit/",
        AdminHotelAmenityEditView.as_view(),
        name="admin_edit_hotel_amenity",
    ),
    path(
        "hotel-amenities/<int:pk>/delete/",
        AdminHotelAmenityDeleteView.as_view(),
        name="admin_delete_hotel_amenity",
    ),
    # Room Types
    path("room-types/", AdminRoomTypeListView.as_view(), name="admin_room_types"),
    path(
        "room-types/add/", AdminRoomTypeCreateView.as_view(), name="admin_add_room_type"
    ),
    path(
        "room-types/<int:pk>/edit/",
        AdminRoomTypeEditView.as_view(),
        name="admin_edit_room_type",
    ),
    path(
        "room-types/<int:pk>/delete/",
        AdminRoomTypeDeleteView.as_view(),
        name="admin_delete_room_type",
    ),
    # User Manager
    ...
    path(
        "users/<int:user_id>/delete/", user_manager_delete, name="user_manager_delete"
    ),
    path(
        "users/<int:user_id>/toggle-status/",
        user_manager_toggle_status,
        name="user_manager_toggle_status",
    ),
    path(
        "users/<int:user_id>/assign-role/",
        user_manager_assign_role,
        name="user_manager_assign_role",
    ),
    path(
        "users/<int:user_id>/remove-role/<int:role_id>/",
        user_manager_remove_role,
        name="user_manager_remove_role",
    ),
    path(
        "users/<int:user_id>/reset-password/",
        user_manager_reset_password,
        name="user_manager_reset_password",
    ),
    path(
        "users/<int:user_id>/generate-password/",
        user_manager_generate_password,
        name="user_manager_generate_password",
    ),
    ...
    path(
        "permissions/<int:permission_id>/edit/",
        admin_permission_edit,
        name="admin_permission_edit",
    ),
    path(
        "permissions/<int:permission_id>/delete/",
        admin_permission_delete,
        name="admin_permission_delete",
    ),
    path(
        "permissions/create-defaults/",
        create_default_permissions,
        name="create_default_permissions",
    ),
    # Roles
    ...
    path(
        ...
        admin_user_role_remove,
        name="admin_user_role_remove",
    ),
    # Soft Delete URLs
    path(
        "bookings/<int:booking_id>/soft-delete/",
        soft_delete_booking,
        name="soft_delete_booking",
    ),
    path("rooms/<int:room_id>/soft-delete/", soft_delete_room, name="soft_delete_room"),
    path(
        "room-types/<int:room_type_id>/soft-delete/",
        soft_delete_room_type,
        name="soft_delete_room_type",
    ),
    path(
        "room-amenities/<int:room_amenity_id>/soft-delete/",
        soft_delete_room_amenity,
        name="soft_delete_room_amenity",
    ),
    path(
        "hotel-amenities/<int:hotel_amenity_id>/soft-delete/",
        soft_delete_hotel_amenity,
        name="soft_delete_hotel_amenity",
    ),
    path(
        "guests/<int:guest_id>/soft-delete/",
        soft_delete_guest,
        name="soft_delete_guest",
    ),
    path(
        "hotels/<int:hotel_id>/soft-delete/",
        soft_delete_hotel,
        name="soft_delete_hotel",
    ),
]
