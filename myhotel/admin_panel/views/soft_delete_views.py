...
def soft_delete_booking(request, booking_id):
    ...
    try:
        ...
        if request.headers.get("X-Requested-With") == "XMLHttpRequest":
            ...
            booking.soft_delete(user=request.user)
            messages.success(
                request, f"Booking for {booking.room} has been deleted successfully."
            )
        ...
        if request.headers.get("X-Requested-With") == "XMLHttpRequest":
            return JsonResponse(
                {"success": False, "message": f"Error deleting booking: {e!s}"},
                status=400,
            )
        else:
            messages.error(request, f"Error deleting booking: {e!s}")
            return redirect("admin_panel:admin_bookings")
...
def soft_delete_room(request, room_id):
    ...
    try:
        ...
        if request.headers.get("X-Requested-With") == "XMLHttpRequest":
            ...
            messages.success(
                request, f"Room {room.room_number} has been deleted successfully."
            )
            return redirect("admin_panel:admin_rooms")
        ...
        if request.headers.get("X-Requested-With") == "XMLHttpRequest":
            return JsonResponse(
                {"success": False, "message": f"Error deleting room: {e!s}"},
                status=400,
            )
        else:
...
def soft_delete_room_type(request, room_type_id):
    ...
    try:
        ...
        if request.headers.get("X-Requested-With") == "XMLHttpRequest":
            ...
            messages.success(
                request, f'Room type "{room_type.name}" has been deleted successfully.'
            )
            return redirect("admin_panel:admin_room_types")
        ...
        if request.headers.get("X-Requested-With") == "XMLHttpRequest":
            return JsonResponse(
                {"success": False, "message": f"Error deleting room type: {e!s}"},
                status=400,
            )
        else:
            messages.error(request, f"Error deleting room type: {e!s}")
            return redirect("admin_panel:admin_room_types")
...
def soft_delete_room_amenity(request, room_amenity_id):
    ...
    try:
        ...
        if request.headers.get("X-Requested-With") == "XMLHttpRequest":
            ...
            messages.success(
                request, f'Room amenity "{amenity.name}" has been deleted successfully.'
            )
            return redirect("admin_panel:admin_room_amenities")
        ...
        if request.headers.get("X-Requested-With") == "XMLHttpRequest":
            return JsonResponse(
                {"success": False, "message": f"Error deleting room amenity: {e!s}"},
                status=400,
            )
        else:
            messages.error(request, f"Error deleting room amenity: {e!s}")
            return redirect("admin_panel:admin_room_amenities")
...
def soft_delete_hotel_amenity(request, hotel_amenity_id):
    ...
    try:
        ...
        if request.headers.get("X-Requested-With") == "XMLHttpRequest":
            ...
            messages.success(
                request,
                f'Hotel amenity "{amenity.name}" has been deleted successfully.',
            )
        ...
        if request.headers.get("X-Requested-With") == "XMLHttpRequest":
            return JsonResponse(
                {
                    "success": False,
                    "message": f"Error deleting hotel amenity: {e!s}",
                },
                status=400,
            )
        else:
            messages.error(request, f"Error deleting hotel amenity: {e!s}")
            return redirect("admin_panel:admin_hotel_amenities")
...
def soft_delete_guest(request, guest_id):
    ...
    try:
        ...
        if request.headers.get("X-Requested-With") == "XMLHttpRequest":
            ...
            messages.success(
                request,
                f'Guest "{guest.first_name} {guest.last_name}" has been deleted successfully.',
            )
        ...
        if request.headers.get("X-Requested-With") == "XMLHttpRequest":
            return JsonResponse(
                {"success": False, "message": f"Error deleting guest: {e!s}"},
                status=400,
            )
        else:
            messages.error(request, f"Error deleting guest: {e!s}")
            return redirect("admin_panel:admin_guests")
...
def soft_delete_hotel(request, hotel_id):
    ...
    try:
        ...
        if request.headers.get("X-Requested-With") == "XMLHttpRequest":
            ...
            messages.success(
                request, f'Hotel "{hotel.name}" has been deleted successfully.'
            )
            return redirect("admin_panel:hotel_list")
        ...
        if request.headers.get("X-Requested-With") == "XMLHttpRequest":
            return JsonResponse(
                {"success": False, "message": f"Error deleting hotel: {e!s}"},
                status=400,
            )
        else:
            messages.error(request, f"Error deleting hotel: {e!s}")
            return redirect("admin_panel:hotel_list")
