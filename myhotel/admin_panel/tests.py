...
from .templatetags.admin_extras import safe_first_char, user_initial
...
class TemplateFilterTests(TestCase):
    def setUp(self):
        ...
        self.user_with_first_name = User.objects.create_user(
            username="testuser1", first_name="John", last_name="Doe"
        )

        self.user_without_first_name = User.objects.create_user(
            username="testuser2", first_name="", last_name="Smith"
        )
